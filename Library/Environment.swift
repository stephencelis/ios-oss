...
public struct Environment {
  ...
  /// A function that returns whether iOS 12 is available
  public let isIOS12Available: () -> Bool
  ...
  public init(
    ...
    isIOS12Available: @escaping () -> Bool = { ksr_isIOS12Available() },
    ...
    self.isIOS12Available = isIOS12Available
